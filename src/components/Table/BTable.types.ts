...
export const TableColumnHeaderVariantsMap: TableColumnVariantsMap = {
	...
	danger: `${commonClasses} bg-red-light text-black hover:text-white hover:bg-red-light focus:ring-4 ring-red`,
	success: `${commonClasses} bg-green-light text-white hover:bg-green-dark focus:ring-4 ring-green`,
}
